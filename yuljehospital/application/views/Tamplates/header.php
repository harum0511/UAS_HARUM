  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Brad Prience</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('index.php/admin_pasien/pendaftaran');?>" class="nav-link">
                  <i class="far fa-circle nav-icon text-warning"></i>
                  <p>Kelola Pendaftaran</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('index.php/admin_pasien/data_pasien');?>" class="nav-link">
                  <i class="far fa-circle nav-icon text-info"></i>
                  <p>Data Pasien</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('index.php/admin_pasien/jadwal_pendaftaran');?>" class="nav-link">
                  <i class="far fa-calendar-alt nav-icon text-success"></i>
          ...
          <?php } ?>
          <!-- Menu Formulir Pendaftaran Online -->
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('index.php/pendaftaranonline');?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?= base_url('index.php/pendaftaranonline/status_saya');?>" class="nav-link">
                  <i class="far fa-circle nav-icon text-info"></i>
                  <p>Status Pendaftaran Saya</p>
                </a>
              </li>
            </ul>
          </li>
